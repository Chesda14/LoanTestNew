        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
              ...
              {{-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/loanplan">
                        <i class="mdi mdi-note menu-icon"></i>
                        <span class="menu-title">Loan Plans</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="/user" class="nav-link" href="pages/icons/mdi.html">
                        <i class="mdi mdi-emoticon menu-icon"></i>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
                ...
                <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                    ...
                    <div class="navbar-brand-wrapper pl-5">
                        {{-- <a class="navbar-brand brand-logo" href="index.html"><img src="images/logo.svg" alt="logo" /></a>
                        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/logo-mini.svg"
                                alt="logo" /></a> --}}
                        <h3 class="font-weight-bold mb-0 d-none d-md-block mt-1 ">Loan Management System</h3>
                    </div>
                    {{-- <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Loan Management System</h4> --}}
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item">
                            <h4 class="mb-0 font-weight-bold d-none d-xl-block">{{ $currentDate }}</h4>
                        </li>
